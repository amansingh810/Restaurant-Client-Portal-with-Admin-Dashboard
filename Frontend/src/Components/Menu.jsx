...
const Menu = () => {
  ...
  return (
    <div className='px-4 py-12 max-w-6x1 mx-auto'>
      {/* Section Header */}
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
        {products.length > 0 ? (
          products
            ...
            .map((product) => (
              <div key={product.id} className='flex items-center gap-6 p-4 border-gray-100 rounded-xl shadow-sm transition hover: shadow-md ' >
